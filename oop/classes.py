...
# аттрибуты и методы которые еть у обьекта, но возможно их нет у класса
...
# print(A.var2) #AttributeError: type jbject 'A' has no attribute var2

print(obj.var1) # переменная класса
print(obj.var2) # переменная обьекта

"Класс иммеет досткп только аттрибутам класса"
"Обьект имеет доступ и к аттрибутам классам, и его аттрибутам"
