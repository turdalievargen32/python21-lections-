'==========================Абстракция================================'
# абстракция - принцип ООП, в котором создается абстрактный класс(класс- пустышка), в котором задаются названия аттрибутов и методов, для того чтобы в дочерних классах переопределяют нужным образом от абстрактных классов мы не создаем обьектов, потому что в них есть только название и нет логики 
